...
Write-Host "Testing AzureBaseline_SecuritySettings_AccountPolicies configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SecuritySettings_AccountPolicies.ps1"
    ...
    AzureBaseline_SecuritySettings_AccountPolicies @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SecuritySettings_AccountPolicies') \
...
Write-Host "    --policy 'GG-Deploy-SecuritySettings_AccountPolicies' \" -ForegroundColor Cyan
