...
param(
    ...
    [string]$PackagePath = ".\Output\AzureBaseline_SecuritySettings_AccountPolicies.zip"
)
...
try
{
    ...
    Write-Host "  Package URI: $packageUri" -ForegroundColor Yellow
    Write-Host "  Configuration Name: AzureBaseline_SecuritySettings_AccountPolicies" -ForegroundColor Yellow
