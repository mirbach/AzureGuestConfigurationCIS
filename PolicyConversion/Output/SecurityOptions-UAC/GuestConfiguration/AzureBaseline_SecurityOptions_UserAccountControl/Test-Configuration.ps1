...
Write-Host "Testing AzureBaseline_SecurityOptions_UserAccountControl configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SecurityOptions_UserAccountControl.ps1"
    ...
    AzureBaseline_SecurityOptions_UserAccountControl @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SecurityOptions_UserAccountControl') \
...
Write-Host "    --policy 'GG-Deploy-SecurityOptions_UserAccountControl' \" -ForegroundColor Cyan
