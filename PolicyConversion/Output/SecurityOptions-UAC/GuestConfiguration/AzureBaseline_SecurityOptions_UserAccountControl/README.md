...
- **AzureBaseline_SecurityOptions_UserAccountControl.ps1**: Main PowerShell DSC configuration
...
```json
{
  ...
  "Package": {
    "Name": "AzureBaseline_SecurityOptions_UserAccountControl",
    "Version": "1.0.0.0",
...
├── AzureBaseline_SecurityOptions_UserAccountControl.ps1  # Main DSC configuration
