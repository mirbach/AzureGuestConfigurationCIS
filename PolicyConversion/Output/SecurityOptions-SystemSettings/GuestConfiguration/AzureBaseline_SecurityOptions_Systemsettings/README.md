...
- **AzureBaseline_SecurityOptions_Systemsettings.ps1**: Main PowerShell DSC configuration
...
```json
{
  ...
  "Package": {
    "Name": "AzureBaseline_SecurityOptions_Systemsettings",
    "Version": "1.0.0.0",
...
├── AzureBaseline_SecurityOptions_Systemsettings.ps1  # Main DSC configuration
