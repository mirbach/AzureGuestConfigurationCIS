...
Write-Host "Testing AzureBaseline_SecurityOptions_Systemsettings configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SecurityOptions_Systemsettings.ps1"
    ...
    AzureBaseline_SecurityOptions_Systemsettings @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SecurityOptions_Systemsettings') \
...
Write-Host "    --policy 'GG-Deploy-SecurityOptions_Systemsettings' \" -ForegroundColor Cyan
