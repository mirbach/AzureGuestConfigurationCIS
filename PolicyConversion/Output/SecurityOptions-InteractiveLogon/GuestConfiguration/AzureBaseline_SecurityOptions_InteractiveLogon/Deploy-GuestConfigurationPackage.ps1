...
param(
    ...
    [string]$PackagePath = ".\Output\AzureBaseline_SecurityOptions_InteractiveLogon.zip"
)
...
try
{
    ...
    Write-Host "  Package URI: $packageUri" -ForegroundColor Yellow
    Write-Host "  Configuration Name: AzureBaseline_SecurityOptions_InteractiveLogon" -ForegroundColor Yellow
