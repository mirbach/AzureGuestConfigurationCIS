...
Write-Host "Testing AzureBaseline_SecurityOptions_InteractiveLogon configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SecurityOptions_InteractiveLogon.ps1"
    ...
    AzureBaseline_SecurityOptions_InteractiveLogon @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SecurityOptions_InteractiveLogon') \
...
Write-Host "    --policy 'GG-Deploy-SecurityOptions_InteractiveLogon' \" -ForegroundColor Cyan
