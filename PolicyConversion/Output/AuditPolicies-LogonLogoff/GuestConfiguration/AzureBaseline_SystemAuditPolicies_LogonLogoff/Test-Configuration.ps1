...
Write-Host "Testing AzureBaseline_SystemAuditPolicies_LogonLogoff configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SystemAuditPolicies_LogonLogoff.ps1"
    ...
    AzureBaseline_SystemAuditPolicies_LogonLogoff @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SystemAuditPolicies_LogonLogoff') \
...
Write-Host "    --policy 'GG-Deploy-SystemAuditPolicies_LogonLogoff' \" -ForegroundColor Cyan
