...
param(
    ...
    [string]$PackagePath = ".\Output\AzureBaseline_SystemAuditPolicies_LogonLogoff.zip"
)
...
try
{
    ...
    Write-Host "  Package URI: $packageUri" -ForegroundColor Yellow
    Write-Host "  Configuration Name: AzureBaseline_SystemAuditPolicies_LogonLogoff" -ForegroundColor Yellow
