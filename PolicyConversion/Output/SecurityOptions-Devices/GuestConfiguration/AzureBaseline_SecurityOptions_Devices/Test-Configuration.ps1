...
Write-Host "Testing AzureBaseline_SecurityOptions_Devices configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SecurityOptions_Devices.ps1"
    ...
    AzureBaseline_SecurityOptions_Devices @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SecurityOptions_Devices') \
...
Write-Host "    --policy 'GG-Deploy-SecurityOptions_Devices' \" -ForegroundColor Cyan
