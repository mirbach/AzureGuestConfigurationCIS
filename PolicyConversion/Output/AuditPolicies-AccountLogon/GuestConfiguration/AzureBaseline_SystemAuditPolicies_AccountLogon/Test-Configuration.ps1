...
Write-Host "Testing AzureBaseline_SystemAuditPolicies_AccountLogon configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SystemAuditPolicies_AccountLogon.ps1"
    ...
    AzureBaseline_SystemAuditPolicies_AccountLogon @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SystemAuditPolicies_AccountLogon') \
...
Write-Host "    --policy 'GG-Deploy-SystemAuditPolicies_AccountLogon' \" -ForegroundColor Cyan
