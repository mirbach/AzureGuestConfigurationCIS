...
- **AzureBaseline_SystemAuditPolicies_AccountLogon.ps1**: Main PowerShell DSC configuration
...
```json
{
  ...
  "Package": {
    "Name": "AzureBaseline_SystemAuditPolicies_AccountLogon",
    "Version": "1.0.0.0",
...
├── AzureBaseline_SystemAuditPolicies_AccountLogon.ps1  # Main DSC configuration
