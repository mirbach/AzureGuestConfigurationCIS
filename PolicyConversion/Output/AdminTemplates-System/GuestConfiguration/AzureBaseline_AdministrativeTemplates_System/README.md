...
- **AzureBaseline_AdministrativeTemplates_System.ps1**: Main PowerShell DSC configuration
...
```json
{
  ...
  "Package": {
    "Name": "AzureBaseline_AdministrativeTemplates_System",
    "Version": "1.0.0.0",
...
├── AzureBaseline_AdministrativeTemplates_System.ps1  # Main DSC configuration
