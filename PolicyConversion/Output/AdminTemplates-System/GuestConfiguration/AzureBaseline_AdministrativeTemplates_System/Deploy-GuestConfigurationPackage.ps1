...
param(
    ...
    [string]$PackagePath = ".\Output\AzureBaseline_AdministrativeTemplates_System.zip"
)
...
try
{
    ...
    Write-Host "  Package URI: $packageUri" -ForegroundColor Yellow
    Write-Host "  Configuration Name: AzureBaseline_AdministrativeTemplates_System" -ForegroundColor Yellow
