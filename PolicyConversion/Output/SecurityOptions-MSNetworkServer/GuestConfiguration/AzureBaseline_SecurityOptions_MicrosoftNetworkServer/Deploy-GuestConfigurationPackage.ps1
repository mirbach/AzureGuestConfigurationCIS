...
param(
    ...
    [string]$PackagePath = ".\Output\AzureBaseline_SecurityOptions_MicrosoftNetworkServer.zip"
)
...
try
{
    ...
    Write-Host "  Package URI: $packageUri" -ForegroundColor Yellow
    Write-Host "  Configuration Name: AzureBaseline_SecurityOptions_MicrosoftNetworkServer" -ForegroundColor Yellow
