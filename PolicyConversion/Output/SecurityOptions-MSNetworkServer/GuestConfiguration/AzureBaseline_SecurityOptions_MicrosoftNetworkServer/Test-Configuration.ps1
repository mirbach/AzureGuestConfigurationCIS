...
Write-Host "Testing AzureBaseline_SecurityOptions_MicrosoftNetworkServer configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SecurityOptions_MicrosoftNetworkServer.ps1"
    ...
    AzureBaseline_SecurityOptions_MicrosoftNetworkServer @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SecurityOptions_MicrosoftNetworkServer') \
...
Write-Host "    --policy 'GG-Deploy-SecurityOptions_MicrosoftNetworkServer' \" -ForegroundColor Cyan
