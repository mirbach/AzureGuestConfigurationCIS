...
Write-Host "Testing AzureBaseline_SystemAuditPolicies_PolicyChange configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SystemAuditPolicies_PolicyChange.ps1"
    ...
    AzureBaseline_SystemAuditPolicies_PolicyChange @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SystemAuditPolicies_PolicyChange') \
...
Write-Host "    --policy 'GG-Deploy-SystemAuditPolicies_PolicyChange' \" -ForegroundColor Cyan
