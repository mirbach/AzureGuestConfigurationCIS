...
- **AzureBaseline_SystemAuditPolicies_PolicyChange.ps1**: Main PowerShell DSC configuration
...
```json
{
  ...
  "Package": {
    "Name": "AzureBaseline_SystemAuditPolicies_PolicyChange",
    "Version": "1.0.0.0",
...
├── AzureBaseline_SystemAuditPolicies_PolicyChange.ps1  # Main DSC configuration
