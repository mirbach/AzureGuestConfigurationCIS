...
param(
    ...
    [string]$PackagePath = ".\Output\AzureBaseline_SystemAuditPolicies_PolicyChange.zip"
)
...
try
{
    ...
    Write-Host "  Package URI: $packageUri" -ForegroundColor Yellow
    Write-Host "  Configuration Name: AzureBaseline_SystemAuditPolicies_PolicyChange" -ForegroundColor Yellow
