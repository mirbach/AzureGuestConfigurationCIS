...
- **AzureBaseline_SystemAuditPolicies_System.ps1**: Main PowerShell DSC configuration
...
```json
{
  ...
  "Package": {
    "Name": "AzureBaseline_SystemAuditPolicies_System",
    "Version": "1.0.0.0",
...
├── AzureBaseline_SystemAuditPolicies_System.ps1  # Main DSC configuration
