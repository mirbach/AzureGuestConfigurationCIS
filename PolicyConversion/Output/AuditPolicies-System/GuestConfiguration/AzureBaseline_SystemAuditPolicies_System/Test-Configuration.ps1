...
Write-Host "Testing AzureBaseline_SystemAuditPolicies_System configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SystemAuditPolicies_System.ps1"
    ...
    AzureBaseline_SystemAuditPolicies_System @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SystemAuditPolicies_System') \
...
Write-Host "    --policy 'GG-Deploy-SystemAuditPolicies_System' \" -ForegroundColor Cyan
