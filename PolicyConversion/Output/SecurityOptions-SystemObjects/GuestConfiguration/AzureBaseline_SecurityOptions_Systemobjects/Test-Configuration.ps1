...
Write-Host "Testing AzureBaseline_SecurityOptions_Systemobjects configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SecurityOptions_Systemobjects.ps1"
    ...
    AzureBaseline_SecurityOptions_Systemobjects @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SecurityOptions_Systemobjects') \
...
Write-Host "    --policy 'GG-Deploy-SecurityOptions_Systemobjects' \" -ForegroundColor Cyan
