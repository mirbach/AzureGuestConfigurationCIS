...
Write-Host "Testing AzureBaseline_AdministrativeTemplates_MSSLegacy configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_AdministrativeTemplates_MSSLegacy.ps1"
    ...
    AzureBaseline_AdministrativeTemplates_MSSLegacy @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-AdministrativeTemplates_MSSLegacy') \
...
Write-Host "    --policy 'GG-Deploy-AdministrativeTemplates_MSSLegacy' \" -ForegroundColor Cyan
