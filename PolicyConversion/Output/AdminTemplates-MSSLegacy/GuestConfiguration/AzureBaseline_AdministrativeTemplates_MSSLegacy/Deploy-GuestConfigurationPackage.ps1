...
param(
    ...
    [string]$PackagePath = ".\Output\AzureBaseline_AdministrativeTemplates_MSSLegacy.zip"
)
...
try
{
    ...
    Write-Host "  Package URI: $packageUri" -ForegroundColor Yellow
    Write-Host "  Configuration Name: AzureBaseline_AdministrativeTemplates_MSSLegacy" -ForegroundColor Yellow
