...
Write-Host "Testing AzureBaseline_AdministrativeTemplates_ControlPanel configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_AdministrativeTemplates_ControlPanel.ps1"
    ...
    AzureBaseline_AdministrativeTemplates_ControlPanel @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-AdministrativeTemplates_ControlPanel') \
...
Write-Host "    --policy 'GG-Deploy-AdministrativeTemplates_ControlPanel' \" -ForegroundColor Cyan
