...
param(
    ...
    [string]$PackagePath = ".\Output\AzureBaseline_AdministrativeTemplates_ControlPanel.zip"
)
...
try
{
    ...
    Write-Host "  Package URI: $packageUri" -ForegroundColor Yellow
    Write-Host "  Configuration Name: AzureBaseline_AdministrativeTemplates_ControlPanel" -ForegroundColor Yellow
