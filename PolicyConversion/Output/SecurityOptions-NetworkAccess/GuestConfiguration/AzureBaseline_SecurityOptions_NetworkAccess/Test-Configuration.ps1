...
Write-Host "Testing AzureBaseline_SecurityOptions_NetworkAccess configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SecurityOptions_NetworkAccess.ps1"
    ...
    AzureBaseline_SecurityOptions_NetworkAccess @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SecurityOptions_NetworkAccess') \
...
Write-Host "    --policy 'GG-Deploy-SecurityOptions_NetworkAccess' \" -ForegroundColor Cyan
