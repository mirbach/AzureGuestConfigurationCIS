...
- **AzureBaseline_SystemAuditPolicies_DetailedTracking.ps1**: Main PowerShell DSC configuration
...
```json
{
  ...
  "Package": {
    "Name": "AzureBaseline_SystemAuditPolicies_DetailedTracking",
    "Version": "1.0.0.0",
...
├── AzureBaseline_SystemAuditPolicies_DetailedTracking.ps1  # Main DSC configuration
