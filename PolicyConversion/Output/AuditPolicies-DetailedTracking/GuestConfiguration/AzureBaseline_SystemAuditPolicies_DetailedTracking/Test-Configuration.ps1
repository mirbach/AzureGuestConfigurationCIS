...
Write-Host "Testing AzureBaseline_SystemAuditPolicies_DetailedTracking configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SystemAuditPolicies_DetailedTracking.ps1"
    ...
    AzureBaseline_SystemAuditPolicies_DetailedTracking @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SystemAuditPolicies_DetailedTracking') \
...
Write-Host "    --policy 'GG-Deploy-SystemAuditPolicies_DetailedTracking' \" -ForegroundColor Cyan
