...
Write-Host "Testing AzureBaseline_SystemAuditPolicies_PrivilegeUse configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SystemAuditPolicies_PrivilegeUse.ps1"
    ...
    AzureBaseline_SystemAuditPolicies_PrivilegeUse @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SystemAuditPolicies_PrivilegeUse') \
...
Write-Host "    --policy 'GG-Deploy-SystemAuditPolicies_PrivilegeUse' \" -ForegroundColor Cyan
