...
Write-Host "Testing AzureBaseline_AdministrativeTemplates_Network configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_AdministrativeTemplates_Network.ps1"
    ...
    AzureBaseline_AdministrativeTemplates_Network @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-AdministrativeTemplates_Network') \
...
Write-Host "    --policy 'GG-Deploy-AdministrativeTemplates_Network' \" -ForegroundColor Cyan
