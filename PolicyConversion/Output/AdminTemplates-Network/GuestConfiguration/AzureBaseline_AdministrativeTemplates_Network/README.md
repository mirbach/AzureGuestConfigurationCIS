...
- **AzureBaseline_AdministrativeTemplates_Network.ps1**: Main PowerShell DSC configuration
...
```json
{
  ...
  "Package": {
    "Name": "AzureBaseline_AdministrativeTemplates_Network",
    "Version": "1.0.0.0",
...
├── AzureBaseline_AdministrativeTemplates_Network.ps1  # Main DSC configuration
