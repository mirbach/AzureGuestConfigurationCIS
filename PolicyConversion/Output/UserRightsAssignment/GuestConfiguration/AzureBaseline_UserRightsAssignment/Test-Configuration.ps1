...
Write-Host "Testing AzureBaseline_UserRightsAssignment configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_UserRightsAssignment.ps1"
    ...
    AzureBaseline_UserRightsAssignment @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-UserRightsAssignment') \
...
Write-Host "    --policy 'GG-Deploy-UserRightsAssignment' \" -ForegroundColor Cyan
