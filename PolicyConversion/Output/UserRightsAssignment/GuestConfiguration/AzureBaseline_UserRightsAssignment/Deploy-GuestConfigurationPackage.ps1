...
param(
    ...
    [string]$PackagePath = ".\Output\AzureBaseline_UserRightsAssignment.zip"
)
...
try
{
    ...
    Write-Host "  Package URI: $packageUri" -ForegroundColor Yellow
    Write-Host "  Configuration Name: AzureBaseline_UserRightsAssignment" -ForegroundColor Yellow
