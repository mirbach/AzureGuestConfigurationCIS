...
Write-Host "Testing AzureBaseline_SecurityOptions_Recoveryconsole configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SecurityOptions_Recoveryconsole.ps1"
    ...
    AzureBaseline_SecurityOptions_Recoveryconsole @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SecurityOptions_Recoveryconsole') \
...
Write-Host "    --policy 'GG-Deploy-SecurityOptions_Recoveryconsole' \" -ForegroundColor Cyan
