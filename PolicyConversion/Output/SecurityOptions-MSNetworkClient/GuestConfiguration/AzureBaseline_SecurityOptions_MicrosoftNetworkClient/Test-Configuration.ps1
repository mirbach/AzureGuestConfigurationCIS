...
Write-Host "Testing AzureBaseline_SecurityOptions_MicrosoftNetworkClient configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SecurityOptions_MicrosoftNetworkClient.ps1"
    ...
    AzureBaseline_SecurityOptions_MicrosoftNetworkClient @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SecurityOptions_MicrosoftNetworkClient') \
...
Write-Host "    --policy 'GG-Deploy-SecurityOptions_MicrosoftNetworkClient' \" -ForegroundColor Cyan
