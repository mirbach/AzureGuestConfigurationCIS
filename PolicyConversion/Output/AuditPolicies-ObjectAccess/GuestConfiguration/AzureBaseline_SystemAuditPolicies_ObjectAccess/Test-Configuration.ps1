...
Write-Host "Testing AzureBaseline_SystemAuditPolicies_ObjectAccess configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SystemAuditPolicies_ObjectAccess.ps1"
    ...
    AzureBaseline_SystemAuditPolicies_ObjectAccess @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SystemAuditPolicies_ObjectAccess') \
...
Write-Host "    --policy 'GG-Deploy-SystemAuditPolicies_ObjectAccess' \" -ForegroundColor Cyan
