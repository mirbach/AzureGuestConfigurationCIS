...
Write-Host "Testing AzureBaseline_SystemAuditPolicies_AccountManagement configuration..." -ForegroundColor Green
...
try {
    ...
    . ".\AzureBaseline_SystemAuditPolicies_AccountManagement.ps1"
    ...
    AzureBaseline_SystemAuditPolicies_AccountManagement @configParams -OutputPath ".\TestOutput" -WarningAction SilentlyContinue | Out-Null
...
Write-Host "  }" -ForegroundColor Cyan
  New-AzPolicyAssignment -Name 'audit-policy' \
    -PolicyDefinition (Get-AzPolicyDefinition -Name 'GG-Deploy-SystemAuditPolicies_AccountManagement') \
...
Write-Host "    --policy 'GG-Deploy-SystemAuditPolicies_AccountManagement' \" -ForegroundColor Cyan
