...
- **AzureBaseline_SystemAuditPolicies_AccountManagement.ps1**: Main PowerShell DSC configuration
...
```json
{
  ...
  "Package": {
    "Name": "AzureBaseline_SystemAuditPolicies_AccountManagement",
    "Version": "1.0.0.0",
...
├── AzureBaseline_SystemAuditPolicies_AccountManagement.ps1  # Main DSC configuration
