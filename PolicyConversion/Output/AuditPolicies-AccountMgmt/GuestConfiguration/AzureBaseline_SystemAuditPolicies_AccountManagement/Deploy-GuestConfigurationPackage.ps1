...
param(
    ...
    [string]$PackagePath = ".\Output\AzureBaseline_SystemAuditPolicies_AccountManagement.zip"
)
...
try
{
    ...
    Write-Host "  Package URI: $packageUri" -ForegroundColor Yellow
    Write-Host "  Configuration Name: AzureBaseline_SystemAuditPolicies_AccountManagement" -ForegroundColor Yellow
